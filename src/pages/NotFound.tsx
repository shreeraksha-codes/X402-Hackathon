const VIDEO_SRC = "https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260801_001207_ec20d138-aa45-4b2b-ab8c-bdc71607f240.mp4";
...
export default function NotFound() {
  return (
    ...
    >
      ...
      >
        <svg viewBox="0 0 54 40" width="54" height="40" fill="none" aria-hidden="true" style={{ flexShrink: 0 }}>
          <path d="M38 0H26V12H38V0Z" fill="#F9F6EE" />
          <path d="M54 12H38V28H54V12Z" fill="#F9F6EE" />
          <path d="M38 28H26V40H38V28Z" fill="#F9F6EE" />
          <path d="M26 12H16V22H26V12Z" fill="#F9F6EE" />
          <path d="M16 22H8V30H16V22Z" fill="#F9F6EE" />
          <path d="M16 2H6V12H16V2Z" fill="#F9F6EE" />
          <path d="M6 12H0V18H6V12Z" fill="#F9F6EE" />
        </svg>
        <svg viewBox="0 0 164.311 100" width="164.311" height="100" aria-hidden="true" style={{ flexShrink: 0 }}>
          <path
